...
int registro() // Função por cadrastar os usuários no sistema
{
	...
	char sobrenome[40];
	char cargo[40];
	//final da criaçãp de variaveis/string
...
int main()
{
	int opcao=0; //Ddefinindo variáveis
	int laco=1;
	...
	system("cls"); //responsável por limpar a tela
	    ...
	    printf("escolha a opão desejada do menu:\n\n");
	    printf("\t1 - registrar nomes\n");
	    printf("\t2 - consultar nomes\n");
	    printf("\t3 - Deletar nomes\n\n");
	    printf("Opção:"); // fim do menu
	
	    scanf("%d", &opcao); //Armazenamenando a escolha do usuário
